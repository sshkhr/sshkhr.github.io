---
layout: post
title: To build a Rainbow: A tutorial on DeepMind's RAINBOW Paper
image: /img/rainbow.png
---

In this blog post I will try to go over the different components of the RAINBOW[[1]] algorithm published by DeepMind in AAAI 2018 along with code examples in PyTorch
